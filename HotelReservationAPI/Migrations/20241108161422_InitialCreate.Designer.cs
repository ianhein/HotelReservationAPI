...
namespace HotelReservationAPI.Migrations
{
    ...
    [Migration("20241108161422_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelReservationAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelReservationAPI.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("HotelReservationAPI.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelReservationAPI.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
